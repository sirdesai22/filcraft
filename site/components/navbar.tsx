      ...
      <div className="container flex h-14 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent
              side="right"
              className="w-[280px] border-l flex flex-col p-0"
              style={{
            ...
            >
              ...
              <nav className="flex flex-col flex-1 px-6 pt-8 pb-6">
                  ...
                  {NAV_LINKS.map((link) => {
                    ...
                    return (
                      <Link
                        ...
                        className={cn(
                          "block py-3 text-sm font-medium uppercase tracking-[0.2em] transition-colors",
                          active ? "text-[#f5d96a]" : "text-[#a89060]"
                        )}
                        style={{
                          fontFamily: "Cinzel, serif",
                          ...(active && { textShadow: "0 0 10px rgba(245,217,106,0.35)" }),
                        }}
                      >
                        {link.live && (
                ...
                {mounted && (
                  <div className="mt-auto pt-6 border-t border-[rgba(168,144,96,0.2)]">
                    {isConnected && address ? (
                      <Button
                        variant="outline"
                        className="w-full rounded-full border-[rgba(245,217,106,0.3)] bg-[rgba(245,217,106,0.08)] text-[#f5d96a] hover:bg-[rgba(245,217,106,0.15)] hover:border-[rgba(245,217,106,0.5)]"
                        size="default"
                        onClick={() => {
                          disconnect();
                          setOpen(false);
                      ...
                      <Button
                        className="w-full rounded-full border border-[rgba(245,217,106,0.3)] bg-[rgba(245,217,106,0.08)] text-[#f5d96a] hover:bg-[rgba(245,217,106,0.15)]"
                        size="default"
                        onClick={() => {
